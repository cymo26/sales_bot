// Adapted from the canonical shadcn/ui use-toast hook: a tiny module-level
// store (not React context) so `toast()` can be called from anywhere —
// API error handlers, event callbacks — not just component bodies.
